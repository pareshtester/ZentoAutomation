...
public class InvoicesubmissionOninvoicestatus extends Urls {
	...
	String EmployeeuserName=null;
	   String EmployeepassWord=null;
		...
		public void testSteps(String ManagerName,String ManagerpassWord,String nameofcompany,String tob,String phonenumber,String emailid,String branch,
			...
			logger = extent.startTest("Submit Invoice on invoice status page process Test (User:"+cemailid +" domain:"+domainname+")");	 
		...
		System.out.println(vendorid);
			...
			logger.log(LogStatus.INFO, "Test result of Submit Invoice on invoice status page");
        ...
        cip.submitinvoiceonstatussteps(invoiceno);
			}
		@AfterMethod
