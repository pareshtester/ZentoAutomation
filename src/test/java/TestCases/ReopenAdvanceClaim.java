...
public class ReopenAdvanceClaim extends Urls{
	...
	String EmployeeuserName=null;
	   String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String domain,String approvetype,String managerUsername,String managerPassword) throws InterruptedException
			...
			logger = extent.startTest("Reopen Advance claim Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			advancepage.reopensteps(advanceid);
		...
		public void close(){
		   ...
		   public String[][] Authentication() throws Exception{
			   CaptureExcelData ed = new CaptureExcelData();
				...
				data_login=ed.readfile(System.getProperty("user.dir") +"/Excel", "ZentoDataProviderAdvance.xls", "AdvanceReopen");
				return data_login;
