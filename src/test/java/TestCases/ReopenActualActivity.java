...
public class ReopenActualActivity extends Urls {
...
//					actualelements
					...
					actualelements.navigattoapproveactualactivty();
				     ...
				     actualelements.approveActualActivity(approvaluser1, approvalpass1, activityid, "reject");
				     locator.logout();
				     locator.Login(EmployeeuserName, EmployeepassWord, domainname);
				     actualelements.reopenactualactivity(activityid);
					//Thread.sleep(1000);
