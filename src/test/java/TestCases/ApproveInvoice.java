...
public class ApproveInvoice extends Urls {
	...
	String cemailid,String bankname,String accountno,String ifsccode,String pannumber,String domain,String ponum,String invoiceno,String action) throws InterruptedException
	{
	...
	logger = extent.startTest("Approve invoice process Test (User:"+cemailid +" domain:"+domainname+")");	 
	...
	logger.log(LogStatus.INFO, "Test result of Approve invoice Functionality");
//		locator.adminLogin("admin", "Zento123", "Core Zento");
	...
	cip.approveinvoice(ponumber,invoiceno,action);
	...
	data_login=ed.readfile(System.getProperty("user.dir") +"/Excel", "VendorDataProvider.xlsx", "InvoiceApproval");
	return data_login;
