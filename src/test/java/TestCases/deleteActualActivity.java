...
public class deleteActualActivity extends Urls {
	  String domainname="";
		...
		String aspeaker,String actualspeaker,String aothers,String actualothers,String aregfees,String actualregfees) throws InterruptedException
					...
					logger = extent.startTest("Delete actual activity (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
					...
					logger.log(LogStatus.INFO, "Test result of delete actual activity Functionality");
...
//					actualelements
					...
					locator.Login(EmployeeuserName, EmployeepassWord, domainname);
				     actualelements.deleteactualactivitysteps(Month, year, activityid, activity, dateofactivity, venueofactivity, topicofactivity, speakerofactivity, noofpart, 
