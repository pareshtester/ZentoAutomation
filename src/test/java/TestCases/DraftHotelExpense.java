...
public class DraftHotelExpense extends Urls {
...
//		}
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String Date,String hamount,String CB,String hRemarks, String domain, String gstn, String cgst, String sgst, String igst) throws InterruptedException
		    {
			...
			logger = extent.startTest("Drafting Hotel Expense Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			logger.log(LogStatus.INFO, "Test result of Drafting Hotel Expense Functionality");
			//locator.logout();
			//Thread.sleep(1000);
			DraftclaimElements deLocator = PageFactory.initElements(driver, DraftclaimElements.class);
			deLocator.navigateToapplyclaim();
			deLocator.hotelAddSteps(EmployeeuserName,EmployeepassWord,Date,hamount,CB,hRemarks,domainname,gstn,cgst,sgst,igst);
			//deLocator.hotelAddSteps(EmployeeuserName,EmployeepassWord,Date,hamount,CB,hRemarks,domain);
		...
		public void close(){
		   ...
		   public String[][] Authentication() throws Exception{
			   CaptureExcelData ed = new CaptureExcelData();
				...
				data_login=ed.readfile(System.getProperty("user.dir") +"/Excel", "ZentoDataProvider.xls", "HotelClaimData");
				return data_login;
