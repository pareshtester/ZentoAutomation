...
public class DeleteDailyExpense extends Urls {
...
//		    dep.submitdailyexpense(claimid);
			String claimid=dep.addmultipleDailyexpenses(EmployeeuserName, EmployeepassWord, domainname);
			locator.Login(EmployeeuserName, EmployeepassWord, domainname);
			dep.deletedailyexpense(claimid);
