...
public class DeleteLocalExpense extends Urls {
	...
	public void testSteps(String EmployeeuserName,String EmployeepassWord,String Date,String localCity,String localtmode,String Lamount,
		...
		logger = extent.startTest("Deleting Local Claim Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//		Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
		...
		logger.log(LogStatus.INFO, "Test result of Deleting Local Claim Functionality");
		deleteExpenseElements editLocator =  PageFactory.initElements(driver, deleteExpenseElements.class);
		editLocator.deletelocalSteps(EmployeeuserName, EmployeepassWord, claimid, localCity, localCity, localtmode, Lamount, LCB, Lremarks,
				domainname,  gstn, cgst,  sgst,  igst);
		//locator.logout();
		//Thread.sleep(1000);
