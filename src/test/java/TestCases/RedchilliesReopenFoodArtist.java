...
public class RedchilliesReopenFoodArtist extends Urls {
...
public void testSteps(String EmployeeuserName,String EmployeepassWord,String copartnerusername,String copartnerpassword,String managername,
		String managerpassword,String domain,String intime,String outtime) throws InterruptedException, IOException
{
...
logger = extent.startTest("Reopen attendance wise food Expense Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");
Reporter.log("=====User Login=====", true);




logger.log(LogStatus.INFO, "Test result of Reopen attendance wise food Expense Functionality");
