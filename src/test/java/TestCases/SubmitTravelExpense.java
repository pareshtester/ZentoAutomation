...
public class SubmitTravelExpense extends Urls {
	...
	String EmployeeuserName=null;
	   String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String Date,String fromCity,String toCity,String tMode,
			...
			logger = extent.startTest("Submitting Travel Claim Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			logger.log(LogStatus.INFO, "Test result of Submitting Travel Claim Functionality");
			//locator.logout();
			//Thread.sleep(1000);
