...
public class DraftLandlineExpense extends Urls {
...
//		}
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String Date,String lamount,String CB,String lRemarks,String domain,String gstn,String cgst, String sgst, String igst) 
			...
			logger = extent.startTest("Drafting Landline expense Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			logger.log(LogStatus.INFO, "Test result of Drafting Landline expense Functionality");
			//locator.logout();
			//Thread.sleep(1000);
			DraftclaimElements deLocator = PageFactory.initElements(driver, DraftclaimElements.class);
			deLocator.navigateToapplyclaim();
			deLocator.LandlineAddSteps(EmployeeuserName, EmployeepassWord, Date, lamount, CB, lRemarks,domainname,gstn,cgst,sgst,igst);
		...
		public void close(){
		   ...
		   public String[][] Authentication() throws Exception{
			   CaptureExcelData ed = new CaptureExcelData();
				...
				data_login=ed.readfile(System.getProperty("user.dir") +"/Excel", "ZentoDataProvider.xls", "LandlineClaimData");
				return data_login;
