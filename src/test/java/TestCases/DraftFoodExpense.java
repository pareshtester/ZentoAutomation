...
public class DraftFoodExpense extends Urls {
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			deLocator.foodAddSteps(EmployeeuserName,EmployeepassWord,Date,famount,CB,fRemarks,domainname,gstn,cgst,sgst,igst);
		...
		public void close(){
		   ...
		   public String[][] Authentication() throws Exception{
			   CaptureExcelData ed = new CaptureExcelData();
				...
				data_login=ed.readfile(System.getProperty("user.dir") +"/Excel", "ZentoDataProvider.xls", "FoodClaimData");
				return data_login;
