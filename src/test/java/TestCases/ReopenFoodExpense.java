...
public class ReopenFoodExpense extends Urls{
	 ...
	 String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String ApprovalUsername,String ApprovalPassword,String fromDate,String ToDate,
			...
			logger = extent.startTest("Reopen Food Claim Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			logger.log(LogStatus.INFO, "Test result of Reopen Food Claim Functionality");
			...
			deLocator.approvefoodExpense("Wednesday, August 01, 2018", "Friday, August 31, 2018","reopen");
			locator.logout();
			...
			reopenLocators.reopenFoodSteps(claimid);
			//locator.logout();
			//Thread.sleep(1000);
