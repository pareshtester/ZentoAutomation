...
public class EditHotelExpense extends Urls {
	...
	String EmployeeuserName=null;
	   String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String Date,String hamount,String CB,String hRemarks,String domain, String gstn,String cgst, String sgst, String igst) 
			...
			logger = extent.startTest("Edit Hotel Expense Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
			Reporter.log("=====User Login=====", true);
			System.out.println(EmployeeuserName);
			System.out.println(EmployeepassWord);
			SubmitCliamsLocator deLocator = PageFactory.initElements(driver, SubmitCliamsLocator.class);
			String claimid=deLocator.addHexpense(EmployeeuserName,EmployeepassWord,domainname,gstn,cgst,sgst,igst);
			System.out.println(claimid);
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			locator.Login(EmployeeuserName,EmployeepassWord,domainname);
			logger.log(LogStatus.INFO, "Test result of Edit Hotel Expense Functionality");
			EditexpenseDetailsLocator editLocator =  PageFactory.initElements(driver, EditexpenseDetailsLocator.class);
			editLocator.edithotelSteps(EmployeeuserName,EmployeepassWord,claimid,hamount,CB,hRemarks,domainname,gstn,cgst,sgst,igst);
			//locator.logout();
			//Thread.sleep(1000);
		...
		public void close(){
		   ...
		   public String[][] Authentication() throws Exception{
			   CaptureExcelData ed = new CaptureExcelData();
				...
				data_login=ed.readfile(System.getProperty("user.dir") +"/Excel", ExcelFileName, "HotelClaimData");
				return data_login;
