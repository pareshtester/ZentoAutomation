...
public class CreateVendor extends Urls {
	   ...
	   String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String nameofcompany,String tob,String phonenumber,String emailid,String branch,
	        ...
	        // String strDate = dateFormat.format(datetext); 
				driver.get(adminurl);
			logger = extent.startTest("Vendor creation process Test (User:"+cemailid +" domain:"+domainname+")");	 
			...
			vp.navigateToCreatevendor();
			vp.cratevendorsteps(domainname, nameofcompany, tob, phonenumber, emailid, branch, address, country, state, city, pincode, gstn, 
