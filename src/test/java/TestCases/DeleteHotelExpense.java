...
public class DeleteHotelExpense extends Urls {
	 ...
	 String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String Date,String fromCity,String toCity,String tMode,
			...
			logger = extent.startTest("Deleting Hotel Claim Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			logger.log(LogStatus.INFO, "Test result of Deleting Hotel Claim Functionality");
			deleteExpenseElements editLocator =  PageFactory.initElements(driver, deleteExpenseElements.class);
			editLocator.deletehotelSteps(EmployeeuserName, EmployeepassWord, claimid, fromCity, toCity, tMode, tamount, CB, travelRemarks,  domainname,  gstn, cgst,  sgst,  igst);
			//locator.logout();
			//Thread.sleep(1000);
