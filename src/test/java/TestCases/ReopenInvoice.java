...
public class ReopenInvoice extends Urls {
...
//
	logger = extent.startTest("Reopen invoice process Test (User:"+cemailid +" domain:"+domainname+")");	 
	...
	//jyk@gdata.in jylk@gdata.in jylkll@gdata.in jylkllp@gdata.in jylkllp@gdata.in
			...
			System.out.println(vendorid);
//
		logger.log(LogStatus.INFO, "Test result of Reopen invoice Functionality");
...
//		//cip.submitinvoicestatus("21");
		...
		cip.approveinvoice(ponum,invoiceno,"Reject");
		
		driver.get(vendorurl);
	
		locator.VendorLogin(vendorusername,"Vendor123",domainname);
		cip.navigatetoinvoicestatus();
		cip.Reopeninvoice(invoiceno);
		}
		@AfterMethod
