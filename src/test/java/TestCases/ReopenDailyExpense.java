...
public class ReopenDailyExpense extends Urls{
...
//		}
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String worktype,String HQtype,String nighthalt,
				String inoutna,String residential,String managerusername,String managerpassword,String action) throws InterruptedException
		    {
			b.clearData(EmployeeuserName,EmployeepassWord,domainname);
		      ...
		      DraftDailyExpensePage dde = PageFactory.initElements(driver, DraftDailyExpensePage.class);
			...
			System.out.println(EmployeepassWord);
			 ...
			 dep.submitdailyexpenseapi(claimid,domainname);
			 locator.Login(managerusername, managerpassword, domainname);
			 
			
			  dde.navigateToapprovedailyexpense();
		    dep.approvedailyexpense(claimid,action);			
		    locator.logout();
		    locator.Login(EmployeeuserName, EmployeepassWord, domainname);
		    dep.ReopenDailyexpense(claimid);
		...
		//	driver.quit();
		   ...
		   public String[][] Authentication() throws Exception{
			   CaptureExcelData ed = new CaptureExcelData();
				...
				data_login=ed.readfile(System.getProperty("user.dir") +"/Excel", "ZentoDataProvider.xls", "ReopenDailyExpense");
				return data_login;
