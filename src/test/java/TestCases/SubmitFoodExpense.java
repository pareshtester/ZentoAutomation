...
public class SubmitFoodExpense extends Urls {
	...
	String EmployeeuserName=null;
	   String EmployeepassWord=null;
		...
		//	locator.Login(EmployeeuserName,EmployeepassWord);
			...
			logger = extent.startTest("Submitting Food Claim Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
			...
			logger.log(LogStatus.INFO, "Test result of Submitting Food Claim Functionality");
			//locator.logout();
			//Thread.sleep(1000);
