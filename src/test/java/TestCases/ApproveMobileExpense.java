...
public class ApproveMobileExpense extends Urls {
	...
	String EmployeeuserName=null;
	   String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String ApprovalUsername,String ApprovalPassword,String fromDate,String ToDate,
			...
			logger = extent.startTest("Approving Mobile Claim Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			logger.log(LogStatus.INFO, "Test result of Approving Mobile Claim Functionality");
			...
			deLocator.approveMobileExpense(fromDate, ToDate,approveAction);
			//Thread.sleep(1000);
