...
public class CreateInvoice extends Urls{
	   ...
	   String EmployeepassWord=null;
		...
		public void testSteps(String ManagerName,String ManagerpassWord,String nameofcompany,String tob,String phonenumber,String emailid,String branch,
			...
			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
				...
				System.out.println(invoiceupload);
				CreateInvoicePage cip = PageFactory.initElements(driver, CreateInvoicePage.class);
				
			logger = extent.startTest("Invoice creation process Test (User:"+cemailid +" doamin:"+domainname+")");	 
		...
		System.out.println(vendorid);
			...
			logger.log(LogStatus.INFO, "Test result of Invoice creation Functionality");
		//	locator.adminLogin("admin", "Zento123", "Core Zento");
		  ...
		  cip.createinvoicesteps(ponum,invoiceno,invoicedt,invoiceupload,remarks);  
			} 
		@AfterMethod
		...
		public void close(){
		   ...
		   public String[][] Authentication() throws Exception{
			   CaptureExcelData ed = new CaptureExcelData();
				...
				data_login=ed.readfile(System.getProperty("user.dir") +"/Excel", "VendorDataProvider.xlsx", "invoicedata");
				return data_login;
