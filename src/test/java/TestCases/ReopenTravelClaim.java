...
public class ReopenTravelClaim extends Urls{
	 String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String ApprovalUsername,String ApprovalPassword,String fromDate,String ToDate,
			...
			logger = extent.startTest("Reopen Travel Claim Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			logger.log(LogStatus.INFO, "Test result of Reopen Travel Claim Functionality");
			...
			deLocator.approveTravelExpense("Wednesday, August 01, 2018", "Friday, August 31, 2018","reopen");
			locator.logout();
			locator.Login(EmployeeuserName, EmployeepassWord,domainname);
			ReopenClaimLocators reopenLocators = PageFactory.initElements(driver, ReopenClaimLocators.class);
			reopenLocators.reopentravelSteps(claimid);
			//locator.logout();
			//Thread.sleep(1000);
