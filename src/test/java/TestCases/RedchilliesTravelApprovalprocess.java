...
public class RedchilliesTravelApprovalprocess extends Urls {
...
logger = extent.startTest("Attendance wise travel approval Test(User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");
Reporter.log("=====User Login=====", true);


// Loginpage locator = PageFactory.initElements(driver, Loginpage.class);

logger.log(LogStatus.INFO, "Test result of attendance wise travel approval Functionality");
//locator.logout();
//Thread.sleep(1000);
