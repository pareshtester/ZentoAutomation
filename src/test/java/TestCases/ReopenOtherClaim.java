...
public class ReopenOtherClaim extends Urls{
	...
	public void testSteps(String EmployeeuserName,String EmployeepassWord,String ApprovalUsername,String ApprovalPassword,String fromDate,String ToDate,
		...
		logger = extent.startTest("Reopen Others Claim Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//		Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
		...
		logger.log(LogStatus.INFO, "Test result of Reopen Others Claim Functionality");
		...
		deLocator.approveOtherExpense("Wednesday, August 01, 2018", "Friday, August 31, 2018","reopen");
		locator.logout();
		...
		reopenLocators.reopenOtherSteps(claimid);
		//locator.logout();
		//Thread.sleep(1000);
