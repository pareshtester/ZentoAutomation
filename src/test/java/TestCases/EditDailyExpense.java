...
public class EditDailyExpense extends Urls {
...
//		    dep.submitdailyexpense(claimid);
			String claimid=dep.addsingleDailyexpense(EmployeeuserName, EmployeepassWord, domainname);
			locator.Login(EmployeeuserName, EmployeepassWord, domainname);
			dep.editdailyexpense(claimid);
