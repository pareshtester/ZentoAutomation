...
public class DraftTravelexpense extends Urls {
...
//		}
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String Date,String fromCity,String toCity,String tMode,
			...
			logger = extent.startTest("Drafting Travel Expense Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
			Reporter.log("=====User Login=====", true);
			System.out.println(EmployeeuserName);
			System.out.println(EmployeepassWord);
			logger.log(LogStatus.INFO, "Test result of Drafting Travel Expense Functionality");
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			deLocator.travelAddSteps(EmployeeuserName,EmployeepassWord,Date,fromCity,toCity,tMode,tamount,CB,travelRemarks,domainname,gstn,cgst,sgst,igst);
