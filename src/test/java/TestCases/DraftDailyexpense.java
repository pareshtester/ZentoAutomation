...
public class DraftDailyexpense extends Urls {
...
//		}
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String worktype,String HQtype,String nighthalt,
			...
			//	locator.Login(EmployeeuserName,EmployeepassWord);
				...
				b.clearData("4300",EmployeepassWord,"fulcrum");
			//DateFormat dateFormat = new SimpleDateFormat("yyyy-mm-dd hh:mm:ss");  
	        // String strDate = dateFormat.format(datetext); 
			logger = extent.startTest("Drafting Food Expense Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			//locator.logout();
			//Thread.sleep(1000);
			DraftDailyExpensePage deLocator = PageFactory.initElements(driver, DraftDailyExpensePage.class);
			deLocator.navigateToapplydailyexpense();
			deLocator.applysteps(EmployeeuserName,EmployeepassWord,domainname,worktype, HQtype, nighthalt, inoutna,residential);
