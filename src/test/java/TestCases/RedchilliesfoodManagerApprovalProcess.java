...
public class RedchilliesfoodManagerApprovalProcess extends Urls {
...
public void testSteps(String EmployeeuserName,String EmployeepassWord,String copartnerusername,String copartnerpassword,String managername,String managerpassword,
		String domain,String intime,String outtime,String action) throws InterruptedException, IOException
{
...
logger = extent.startTest("Attendance wise manager food approval Test(User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");
Reporter.log("=====User Login=====", true);




logger.log(LogStatus.INFO, "Test result of attendance wise manager food approval   Functionality");
...
rcp.approvalfoodsteps(foodid,"approve");
locator.logout();
locator.Login(managername, EmployeepassWord, domainname);
rcp.NavigateToReportings();
rcp.approvalsteps(foodid, action);
...
data_login=ed.readfile(System.getProperty("user.dir") +"/Excel", "ZentoDataProvider.xls", "Artistfood");
return data_login;
