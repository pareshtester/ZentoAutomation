...
public class EditLeave extends Urls {
	...
	String EmployeeuserName=null;
	   String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String managername,String managerpassword,String domain) throws InterruptedException
			...
			logger = extent.startTest("Edit leave Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
			Reporter.log("=====User Login=====", true);
			


			logger.log(LogStatus.INFO, "Test result of Edit leave Functionality");
			...
			leavepage.editsteps(leaveid,domainname);
