...
public class SubmitInvoice extends Urls{
	String EmployeeuserName=null;
	   String EmployeepassWord=null;
		...
		public void testSteps(String ManagerName,String ManagerpassWord,String nameofcompany,String tob,String phonenumber,String emailid,String branch,
			...
			logger = extent.startTest("Submit invoice process Test (User:"+cemailid +" domain:"+domainname+")");	 
		...
		System.out.println(vendorid);
			...
			logger.log(LogStatus.INFO, "Test result of Submit invoice Functionality");
		//	locator.adminLogin("admin", "Zento123", "Core Zento");
           ...
           cip.submitinvoicesteps(invoiceno);
			}
		@AfterMethod
