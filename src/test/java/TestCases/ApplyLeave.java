...
public class ApplyLeave extends Urls {
...
logger = extent.startTest("Apply Leave Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");
Reporter.log("=====User Login=====", true);



logger.log(LogStatus.INFO, "Test result of Apply Leave Functionality");
...
leavepage.navigateToLeaveapplyPage();
leavepage.applyleavesteps();
