...
public class DeleteMobileExpense extends Urls {
	...
	public void testSteps(String EmployeeuserName,String EmployeepassWord,String Date,String fromCity,String toCity,String tMode,
		...
		logger = extent.startTest("Deleting Mobile Claim Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//		Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
		...
		logger.log(LogStatus.INFO, "Test result of Deleting Mobile Claim Functionality");
		deleteExpenseElements editLocator =  PageFactory.initElements(driver, deleteExpenseElements.class);
		editLocator.deleteMobileSteps(EmployeeuserName, EmployeepassWord, claimid, fromCity, toCity, tMode, tamount, CB, travelRemarks,  domainname,  gstn, cgst,  sgst,  igst);
		//locator.logout();
		//Thread.sleep(1000);
