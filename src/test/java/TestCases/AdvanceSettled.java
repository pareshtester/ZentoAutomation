...
public class AdvanceSettled extends Urls{
	...
	String EmployeeuserName=null;
	   String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String domain,String approvetype,String managerUsername,String managerPassword,
				String paymentteamusername,String paymentpassword) throws InterruptedException
		    {
			...
			logger = extent.startTest("Advance Request settling process Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
			...
			logger.log(LogStatus.INFO, "Test result of Advance settle Functionality");
		    ...
		    locator.logout();
		    locator.Login(paymentteamusername, paymentpassword,domainname);
		    advancepage.paymentprocesssteps(advanceid);
		...
		public void close(){
		   ...
		   public String[][] Authentication() throws Exception{
			   CaptureExcelData ed = new CaptureExcelData();
				...
				data_login=ed.readfile(System.getProperty("user.dir") +"/Excel", "ZentoDataProviderAdvance.xls", "Advancesettle");
				return data_login;
