...
public class EditActualActivity extends  Urls {
	   String domainname="";
	...
	String aspeaker,String actualspeaker,String aothers,String actualothers,String aregfees,String actualregfees) throws InterruptedException
				...
				logger = extent.startTest("Edit actual  acctivity (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
				...
				logger.log(LogStatus.INFO, "Test result of edit actual activity Functionality");
...
//				actualelements
				...
				locator.Login(EmployeeuserName, EmployeepassWord, domainname);
			     actualelements.editactualactivitysteps(Month, year, activityid, activity, dateofactivity, venueofactivity, topicofactivity, speakerofactivity, noofpart, 
