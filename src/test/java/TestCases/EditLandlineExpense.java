...
public class EditLandlineExpense extends Urls {
	...
	String EmployeeuserName=null;
	   String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String Date,String mamount,String CB,String mRemarks,String domain, String gstn,String cgst, String sgst, String igst) throws InterruptedException
		    {
			...
			logger = extent.startTest("Edit Landline Expense Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
			Reporter.log("=====User Login=====", true);
			System.out.println(EmployeeuserName);
			System.out.println(EmployeepassWord);
			SubmitCliamsLocator deLocator = PageFactory.initElements(driver, SubmitCliamsLocator.class);
			String claimid=deLocator.addLandlineexpense(EmployeeuserName,EmployeepassWord,domainname,gstn,cgst,sgst,igst);
			System.out.println(claimid);
			
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			locator.Login(EmployeeuserName,EmployeepassWord,domainname);
			logger.log(LogStatus.INFO, "Test result of Edit Landline Expense Functionality");
			EditexpenseDetailsLocator editLocator =  PageFactory.initElements(driver, EditexpenseDetailsLocator.class);
			editLocator.editlandlinesteps(EmployeeuserName,EmployeepassWord,claimid,mamount,CB,mRemarks,domainname,gstn,cgst,sgst,igst);
			//locator.logout();
			//Thread.sleep(1000);
