...
public class ReopenRedchilliesTravelclaim extends Urls{
...
logger.log(LogStatus.INFO, "Test result of Reopen attendance wise Local Expense Functionality");
//locator.logout();
//Thread.sleep(1000);
