...
public class RedchilliesDeleteFoodExpense extends Urls {
...
logger = extent.startTest("Deleting attendance wise Food Expense Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");
Reporter.log("=====User Login=====", true);




logger.log(LogStatus.INFO, "Test result of Deleting attendance wise Food Expense Functionality");
