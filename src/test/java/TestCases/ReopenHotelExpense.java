...
public class ReopenHotelExpense extends Urls {
	 ...
	 String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String ApprovalUsername,String ApprovalPassword,String fromDate,String ToDate,
			...
			logger = extent.startTest("Reopen Hotel Claim Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");	 
...
//			Loginpage locator = PageFactory.initElements(driver, Loginpage.class);
			...
			logger.log(LogStatus.INFO, "Test result of Reopen Hotel Claim Functionality");
			deLocator.submithotelexpensesteps( EmployeeuserName, EmployeepassWord, domainname,  gstn,  cgst,  sgst,  igst);
			locator.logout();
			locator.Login(ApprovalUsername, EmployeepassWord,domainname);
			deLocator.NavigateToReportings();
			deLocator.approvehotelExpense("Wednesday, August 01, 2018", "Friday, August 31, 2018","reopen");
			locator.logout();
			...
			reopenLocators.reopenhotelSteps(claimid);
			//locator.logout();
			//Thread.sleep(1000);
