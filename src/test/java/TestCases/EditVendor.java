...
public class EditVendor extends Urls {
	...
	String EmployeeuserName=null;
	   String EmployeepassWord=null;
		...
		public void testSteps(String EmployeeuserName,String EmployeepassWord,String nameofcompany,String tob,String phonenumber,String emailid,String branch,
			...
			logger = extent.startTest("Edit Vendor process Test (User:"+cemailid +" domain:"+domainname+")");	 
			...
			if(!(nameofcompany==null) && !(tob==null) && !(phonenumber==null) &&  !(emailid==null) && !(branch==null) && !(address==null) 
					&& !(country==null) && !(state==null) && !(city==null) && !(pincode==null) && !(gstn==null) && !(contactperson==null)
					&& !(designation==null)&&! (mobilenumber==null)&& !(cemailid==null) && !(bankname==null) &&!(accountno==null)&&
					!(ifsccode==null)&& !(pannumber==null))
			{
		...
		System.out.println(vendorusername);
			...
			logger.log(LogStatus.INFO, "Test result of Edit Vendor Functionality");
			locator.adminLogin("admin", "Zento123", domainname);
			System.out.println(vendorusername);
		vp.navigateToexistingvendor();
		vp.editvendorsteps(vendorusername,domainname, nameofcompany, tob, phonenumber, emailid, branch, address, country, state, city, pincode, gstn, 
				contactperson, designation,mobilenumber , cemailid, bankname, accountno, ifsccode, pannumber);
			}
		@AfterMethod
