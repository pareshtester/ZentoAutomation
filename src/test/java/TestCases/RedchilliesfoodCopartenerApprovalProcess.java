...
public class RedchilliesfoodCopartenerApprovalProcess extends Urls {
...
logger = extent.startTest("Attendancewise food copartener approval Test (User:"+EmployeeuserName +" pass:"+EmployeepassWord+")");
Reporter.log("=====User Login=====", true);




logger.log(LogStatus.INFO, "Test result attendancewise food copartener approval Functionality");
...
rcp.approvalfoodsteps(foodid,action);
